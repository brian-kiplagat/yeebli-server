...
export const userSchema = mysqlTable('user', {
  ...
  stripe_account_status: mysqlEnum('stripe_account_status', ['pending', 'active', 'rejected', 'restricted']).default(
    'pending',
  ),
...
export const eventSchema = mysqlTable('events', {
  ...
  event_type: mysqlEnum('event_type', ['live_venue', 'prerecorded', 'live_video_call']).default('prerecorded'),
...
export const pricePlans = mysqlTable('price_plans', {
  ...
  recurring_payment: boolean('recurring_payment').default(false),
  created_at: timestamp('created_at').defaultNow(),
  updated_at: timestamp('updated_at').defaultNow().onUpdateNow(),
});
...
export const assetsSchema = mysqlTable('assets', {
  ...
  processing_status: mysqlEnum('processing_status', ['pending', 'processing', 'completed', 'failed']).default(
    'pending',
  ),
  created_at: timestamp('created_at').defaultNow(),
  updated_at: timestamp('updated_at').defaultNow().onUpdateNow(),
