...
import { type SubscriptionRequestBody, subscriptionRequestValidator } from '../validator/subscription.js';
...
export class SubscriptionController {
  ...
  constructor(subscriptionService: SubscriptionService, stripeService: StripeService, userService: UserService) {
