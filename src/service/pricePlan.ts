...
export class PricePlanService {
  ...
  public async getAllPricePlans(query?: PricePlanQuery): Promise<{ plans: PricePlan[]; total: number }> {
    return await this.repository.findAll(query);
  }

  public async updatePricePlan(id: number, plan: Partial<PricePlan>): Promise<void> {
